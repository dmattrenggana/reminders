...
export const REMINDER_VAULT_V2_ABI = [
  ...
  "function getReminder(uint256 reminderId) view returns (address user, uint256 commitAmount, uint256 rewardPoolAmount, uint256 reminderTime, uint256 confirmationDeadline, bool confirmed, bool burned, string memory description, string memory farcasterUsername, uint256 totalReminders, uint256 rewardsClaimed)",
